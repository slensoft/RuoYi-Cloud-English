...
public class SysMenu extends BaseEntity
{
    ...
    /** Route name, default is the same as route address in camel case (Note: because vue3 version router will delete routes with the same name, to avoid name conflicts, you can customize in special cases) */
    private String routeName;

    /** Is external link (0 yes 1 no) */
    private String isFrame;

    /** Is cached (0 cached 1 not cached) */
